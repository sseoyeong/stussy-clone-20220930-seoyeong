...
import com.stussy.stussyclone20220930seoyeong.domain.User;
import com.stussy.stussyclone20220930seoyeong.dto.validation.ValidationGroups;
import lombok.Data;
...
public class RegisterReqDto {
    ...
    @Pattern(regexp = "^[가-힇]*$", message = "한글만 입력 가능합니다", groups = ValidationGroups.PatterCheckGroup.class)
    ...
    @Pattern(regexp = "^(?=.*[a-zA-Z])(?=.*\\d)(?=.*[~!@#$%^&*-_])[a-zA-Z\\d-~!@#$%^&*_]*$", message = "비밀번호는 특수기호, 영문, 숫자를 모두 포함해야합니다", groups = ValidationGroups.PatterCheckGroup.class)
