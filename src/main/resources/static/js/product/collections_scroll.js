...
class PageScroll {
    ...
    addScrollPagingEvent() {
        ...
        window.onscroll = () => {
            ...
            let scrollStatus = bosy.offsetHeight - html.clientHeight - html.scrollTop;
            console.lof("현재 스크롤 상태");
...
class CollectionsService {
    ...
    loadCollections() {
        if(this.loadCollectionsEntity.page == 1 || this.collectionsEntity.page < Number(this.collectionsEntity.maxPage) + 1) {
