const RegisterEventService = {
    ...
    addCategorySelectEvent: function() {
        this.getCategorySelectObj.onchange = () => {
            ...
            RegisterObj.category = thos.getCategorySelectObj().value;
        }
    ...
    addRegistButtonEvent: function() {
        this.getRegistButtonObj().onclick = () => {
            RegisterRequest.simpleInfo = this.getInfoTextareaObjs()[3].value,
            RegisterRequest.detailInfo = this.getInfoTextareaObjs()[4].value,
            RegisterRequest.optionInfo = this.getInfoTextareaObjs()[5].value,
            RegisterRequest.managementInfo = this.getInfoTextareaObjs()[6].value,
            RegisterRequest.shippingInfo = this.getInfoTextareaObjs()[7].value
